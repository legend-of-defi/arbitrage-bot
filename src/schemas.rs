...
diesel::table! {
    ...
    pairs (id) {
        ...
        /// (Automatically generated by Diesel.)
        usd -> Nullable<Int4>,
        /// The `is_valid` column of the `pairs` table.
        ///
...
diesel::table! {
    ...
    tokens (id) {
        ...
        /// Exchange rate of the token in USD using Numeric for precise decimal representation
        exchange_rate -> Nullable<Numeric>,
        /// Timestamp of when the exchange rate was last updated
        updated_last -> Nullable<Timestamp>,
        /// The `is_valid` column of the `tokens` table.
        ///
        /// Its SQL type is `Bool`.
        ///
        /// (Automatically generated by Diesel.)
